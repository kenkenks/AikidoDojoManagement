...
function runner_paymentLogStep7A_portableDao_realSheets() {
  ...
  try {
    var headers=['payment_id','日時','target_month','billing_group_id','invoice_id','支払方法','入金額','決済ID','備考','reception_date','location_id','billing_block_id','teacher_id','reception_session_id','guard'];
    ...
    var record={payment_id:'PAY-STEP7A',日時:'2099-07-09T02:00:00Z',target_month:'2099-07',billing_group_id:'G001',invoice_id:'INV-STEP7A',支払方法:'現金',入金額:7500,決済ID:'CASH-STEP7A',備考:'STEP7A',reception_date:'2099-07-09',location_id:'HONBU',billing_block_id:'B_KYO_MON_1030_1230',teacher_id:'T001',reception_session_id:'RUN-STEP7A'};
